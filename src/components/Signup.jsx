            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white py-8 px-8 shadow sm:rounded-lg sm:px-10">
                    <form className="space-y-6">
                        {/* Name */}
                        <div>
                            <label htmlFor="name" className='block tet-sm font-medium text-gray-700'>
                                Full Name
                            </label>
                        ...
                        <div className="">
                            ...
                            <div className="mt-2 flex items-center">
                                ...
                                <label htmlFor="file-input" className='ml-5 flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700
